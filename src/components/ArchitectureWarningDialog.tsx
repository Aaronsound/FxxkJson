...
const ArchitectureWarningDialog: React.FC<ArchitectureWarningDialogProps> = ({ isDarkMode, onClose, onOpenAbout }) => (
  <div className="modal-overlay" role="dialog" aria-modal="true" aria-labelledby="architecture-warning-title">
    ...
    >
      ...
      <p className="architecture-warning-text">
        当前在 M 系列 Mac 上通过 Rosetta 运行 x64 版本。建议下载安装 macos-arm64 包，可以明显改善启动、导入和格式化大
        JSON 的流畅度。
      </p>
