...
export function useJsonEditorModelSync({
  ...
  const syncLeftModel = useCallback((tabId: string, content: string, forceValue = false) => {
  ...
  const syncRightModel = useCallback((tabId: string, content: string, forceValue = false) => {
